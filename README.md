...
Traditionally RPC/RMI implements a stub interface and is tightly coupled. NLC however can function without a stuf interface, and is loosly coupled. NLC also implements end to end encryption (alongside an Eliptic Curve Diffie-Hellman Handshake), DEFLATE compression, client isolation, and a stupidly simple implementation. 
...
Console.WriteLine(client.CombineTwoStringsAndReturn("I'm a ", "real boy!")); // Returns "I'm a real boy!"
```
## Sample Outputs
